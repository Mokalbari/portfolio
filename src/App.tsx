...
const App = () => {
  return (
    <div className="relative mx-4 my-8 max-w-[600px] rounded-lg border border-black bg-white px-4 shadow-full sm:mx-auto sm:my-16 sm:px-16 sm:py-8">
      ...
      <aside>
        <SvgEllipse className="absolute right-2 top-2 max-sm:max-w-12 max-sm:-translate-y-8 max-sm:translate-x-4" />
        <SvgDoublePlay
        ...
        <SvgFlower className="absolute -bottom-36 -right-0 -z-10 sm:hidden" />
